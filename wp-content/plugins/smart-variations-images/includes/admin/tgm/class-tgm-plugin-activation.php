		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_activate_required'    => _n_noop(
					/* translators: 1: plugin name(s). */
					'<b>Smart Varitions Images</b> The following inactive plugin: %1$s.',
					'<b>Smart Varitions Images</b> The following inactive plugin: %1$s.',
					'tgmpa'
				),
				'notice_can_activate_recommended' => _n_noop(
					/* translators: 1: plugin name(s). */
					'asdaslugin is currently inactive: %1$s.',
					'The following dasdasdas plugins are currently inactive: %1$s.',
					'tgmpa'
				),
